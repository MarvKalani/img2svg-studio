...
const englishText: Readonly<Record<string, string>> = Object.freeze({
  ...
  Arbeitsflächenfarbe: "Workspace color",
  Aus: "Off",
  Ausgewogen: "Balanced",
  Bereit: "Ready",
  Bearbeitet: "Edited",
  Benutzerdefiniert: "Custom",
  "Bitte einen Preset-Namen mit 1 bis 60 Zeichen eingeben.":
    "Enter a preset name containing 1 to 60 characters.",
  ...
  Dateiinformationen: "File information",
  ...
  "Die Konvertierung wurde abgebrochen.": "The conversion was cancelled.",
  Downloadfortschritt: "download progress",
  Ein: "On",
  Eingabe: "Input",
  Eingabebild: "Input image",
  Eingeklappt: "Collapsed",
  "Eigene Presets": "Saved presets",
  "Eigene Farbe": "Custom color",
  "Eigene Arbeitsflächenfarbe": "Custom workspace color",
  "Eigenes Preset": "Custom preset",
  Elemente: "Elements",
  "Einmalig gemessen": "Measured once",
  ...
  "ChatGPT verbinden": "Connect ChatGPT",
  "ChatGPT trennen": "Disconnect ChatGPT",
  "Companion nicht erreichbar": "Companion unavailable",
  "Nicht verbunden": "Not connected",
  "Studio verbunden": "Studio connected",
  "Verbinde lokal …": "Connecting locally …",
  "Verbindung unterbrochen": "Connection interrupted",
  Linie: "Line",
  "Linie erkennen": "Detect line",
  Löschen: "Delete",
  "Mitgelieferte Presets": "Built-in presets",
  ...
  "Name für eigene Einstellung": "Custom setting name",
  ...
  "Seitenleisten-Layout": "Sidebar layout",
  ...
  "SVG wird nach der Konvertierung angezeigt.": "The SVG appears after conversion.",
  ...
  Verlauf: "History",
  "Verlaufs-Layout": "History layout",
  ...
  "Vorschau abgebrochen": "Preview cancelled",
  "Vorschau neu starten": "Restart preview",
  ...
  "Zoom in Prozent": "Zoom percent",
  "Zoom auf 100 % zurücksetzen": "Reset zoom to 100%",
  ...
  "Eigene Einstellungen lassen sich benannt im Browser speichern, erneut laden und über WebMCP steuern.":
    "Custom settings can be named, saved in the browser, loaded again, and controlled through WebMCP.",
...
const englishPatterns: readonly Readonly<{
  ...
  pattern(/^Startgröße (.*)$/, (value) => `Initial size ${translateContent(value)}`),
